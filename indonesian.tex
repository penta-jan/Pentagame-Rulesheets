\selectlanguage{bahasa-indonesia}
\renewcommand{\headline}{\section*{{\LARGE{}Penta$\cdot$game} - Bahasa Indonesia}}
\renewcommand{\tocent}{Bahasa Indonesia}
\renewcommand{\translator}{Iqbal Iqbal}
...
tiap pemain. Satu tim memiliki bidak dengan rambut perak, satu dengan rambut hitam, 
satu dengan rambut emas, dan lainnya botak.
...
Tetapi anda diperkenankan berhenti \emph{onto} jika penuh:
...
Siapa pun yang menggerakkan \emph{three }bidaknya disematkan sebagai pemenang.
