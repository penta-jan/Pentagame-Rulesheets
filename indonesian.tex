...
\renewcommand{\headline}{Penta$\cdot$permainan - Bahasa Indonesia}
\renewcommand{\tocent}{Bahasa Indonesia}
\renewcommand{\tocline}{Peraturan dalam Bahasa Indonesia}
...
\renewcommand{\choosex}{
    ...
    Mereka harus mencapai tempat pemberhentian di tengah papan permainan, dimana mereka keluar.
}
...
\renewcommand{\objective}{
    ...
    Pemain pertama yang berhasil memindahkan \emph{tiga} bidak ke tujuan akhir adalah
    pemenangnya.
}
...
\renewcommand{\rules}{
    ...
    Jangan pernah lompat\textemdash melewati blok ataupun bidak. 
    ...
    Jika anda bergerak ke tempat dengan bidak lebih dari satu, pilih satu untuk ditukar. 
     
    \myskip 
     
    Jangan membuat gerakan yang sama dua kali berturut-turut.   
    ...
    Jika blok abu-abu habis, pindahkan salah satu yang sudah ada di dalam permainan.
