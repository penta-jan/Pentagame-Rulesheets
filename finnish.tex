...
\renewcommand{\tocline}{Säännöt suomeksi}
\renewcommand{\translator}{ihmis-suski, bergie}
\renewcommand{\general}{
    \lettrine[lines=3]{P}{eli}, jonka voi selittää minuutissa, mutta joka säilyy mielenkiintoisena vuosia.
...
Jos harmaat nappulat loppuvat, siirrä yhtä niistä, jotka ovat jo pelissä.

\medskip

Jos toinen pelaaja siirtää nappulasi maaliin, sinun täytyy siirtää se pois heti kun vuorosi tulee.
