...
\renewcommand{\tocent}{简体中文}%
\renewcommand{\tocline}{\protect\tocSimpChinesefont 简体中文规则}%
\renewcommand{\translator}{藍文婷}

\renewcommand{\general}{
    一个只需数分钟解释规则却可令人着迷多年的游戏。
    
    $2$ 位玩家游戏时间为 $20$ 分钟。$3$或$4$ 名玩家则为 $90$ 分钟。
    游戏不需要骰子。本游戏适合$5$岁以上的玩家。
    %$Jan$  $Suchanek$ 游戏设计。
    
    盒中含有：$4$组$5$个手绘角色，$5$块黑色以及$5$块灰色木块以及底板
} 
...
\renewcommand{\rules}{
    ...
    若灰色木块已用完，则移动一块已经在场上的灰色木块。
    \myskip
    
    如果其他玩家将您移至目标，则该轮到您时必须将其移除。
    \myskip
