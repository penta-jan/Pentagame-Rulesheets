...
\renewcommand{\tocline}{Regler på svenska}
\renewcommand{\translator}{Excds}
\renewcommand{\general}{
    \lettrine[lines=3]{E}{tt} spel som kan förklaras på under en minut, men som likväl fortsätter att fascinera i åratal. 
    Ett tvåpersonersparti tar bara 20 minuter. Med tre eller fyra spelare kan det ta upp till
    90 minuter.
    Det spelas utan tärning och kan spelas från fem års ålder. 
...
\renewcommand{\objective}{
    Vita figurer vill röra sig till det vita fältet i mitten, blå till det blå
...
\renewcommand{\rules}{
    ...
    Om du i så fall flyttar till en position med en svart blockerarpjäs, kan du
    ...
    av spelbrädet, varpå du tar en av de grå blockerarpjäserna och ställer den på
    ...
    Om de grå blockerarpjäserna tar slut, flytta då en som redan är i spel.
    
    \myskip
    
    Om en annan spelare flyttar en av dina pjäser till dess mål måste du flytta ut den så snart det blir din tur.
