...
\renewcommand{\tocline}{Regeln auf Deutsch}
\renewcommand{\translator}{J.S.}
\renewcommand{\general}{
\lettrine[lines=3]{E}{in} Spiel, das man in einer Minute begreift, das aber immerzu fasziniert. 
...
Wer \emph{drei} seiner Figuren auf ihre jeweiligen Ziele zieht, gewinnt.
}
...
Wenn keine grauen Blöcke mehr da sind, versetze einen, der bereits im Spiel ist.
