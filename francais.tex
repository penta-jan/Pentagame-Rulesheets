...
\renewcommand{\tocline}{Règles en français}
...
\renewcommand{\objective}{
    ...
    Déplacez trois de vos cinq pions sur leur cercles intérieurs colorés respectifs pour gagner.
}
...
\renewcommand{\rules}{
    ...
    Si vous manquez de blocs gris, repositionnez un qui est déjà dans le jeu.
