...
\renewcommand{\tocline}{Rules in English}
...
Move \emph{three} pieces to their destinations to win.
}
...
If you run out of grey blocks, re-position one that is already in the game.
