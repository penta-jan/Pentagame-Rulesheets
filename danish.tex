...
\renewcommand{\general}{
    ...
    Indhold: 4$\times$5 farvede figurer, 5 sorte og 5 grå kuber og en spilleplade.
}
...
\renewcommand{\rules}{
    Når det er din tur, må du flytte én af dine figurer langs linjerne.
	...
	Hvis der ikke er flere ledige grå kuber på midten af spillepladen, må spilleren flytte en vilkårlig grå kube.
    ...
    Hvis en anden spiller flytter én af dine figurer til dens mål, emph{skal }du bruge din næste tur på at flytte figuren ind på midten af spillepladen.
    
    \myskip
    
    Den sidste runde spilles færdig, så alle spillere får det samme antal træk.
}