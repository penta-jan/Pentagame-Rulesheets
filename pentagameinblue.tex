...
\definecolor{myblau}{HTML}{00adef}
 


\newcommand{\obere}{
  |  \Large|  Αἰών | \Large|  παίς | \Large |  ἔσvτι | \Large |  παίζων, |\Large| πεσvσvεύων· 
}



\newcommand{\untere}{
   | \Large| παιδὸς | \Large | ἡ | \Large |  βασvιλῄη. 
}


\begin{tikzpicture}
\begin{scope}
\draw[color=gray,fill=myblau] (0,0) circle (3.5cm);
