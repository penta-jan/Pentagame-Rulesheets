...
\newcommand{\myhead}{\begin{centering}{\sffamily\Large{\textbf\headline}}\addcontentsline{toc}{section}{\tocent}\end{centering}}

\newcommand{\layout}{
\begin{framed}
    {{\sffamily{\Large{\textbf{\tocent}}}}}
\end{framed}
