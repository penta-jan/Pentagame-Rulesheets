...
\newpage
    ...
    \begin{tikzpicture}
        ...
        \node[statez, fill=blue] at (2,2) {};
        \node[statez, fill=red] at (3,2) {};
        \node[statez, fill=yellow] at (4,2) {};
        \node[statez, fill=green] at (5,2) {};

        \node[bob, minimum size=1cm] at (-1,0) (bob) {};
        \node[statezz, fill=white] at (1,0) {};
        \node[statezz, fill=blue] at (2,0) {};
        \node[statezz, fill=red] at (3,0) {};
        \node[statezz, fill=yellow] at (4,0) {};
        \node[statezz, fill=green] at (5,0) {};
...
\boardy
    ...
    All pieces start at the rim, on the stop of their colour.
...
\boardy
    ...
    \node[statez, fill=gray] (g1) at (-2,-6) {}; 
    \node[statez, fill=gray] (g1) at (-1,-6) {}; 
    \node[statez, fill=gray] (g1) at (0,-6) {}; 
    \node[statez, fill=gray] (g1) at (1,-6) {}; 
    \node[statez, fill=gray] (g1) at (2,-6) {}; 
