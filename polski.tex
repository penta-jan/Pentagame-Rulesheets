...
\renewcommand{\tocline}{Zasady po polsku}
\renewcommand{\translator}{E.A.Szyszka}
\renewcommand{\general}{
    \lettrine[lines=3]{G}{ra,} którą pojmiesz w kilka minut, a będzie Cię fascynować latami.
    W dwóch graczy jedna partia gry trwa jedynie 20 minut. W trzy lub cztery osoby, gra potrwa około 40-90 minut. 
    Gra nie zawiera kości, jest odpowiednia dla graczy od 5 roku życia. 
    Pudełko zawiera: 4$\times$5 kolorowe pionki, 5 czarnych i 5 szarych pionków oraz planszę do gry.
}
...
\renewcommand{\rules}{
    ...
    Można przejść do pola, które jest zajęte i trafione:
    \myskip
    ...
    Jeśli nie ma już szarych bloków, przesuń ten, który już jest w grze.

    \myskip
    
    Jeżeli inny gracz przeniósł Cię do celu, to podczas Twojej rundy musisz się wycofać. 
    
    %Jeśli inny gracz zbliżył Cię do celu, musisz wyjść, gdy tylko nadejdzie Twoja kolej.
    \myskip
    
    Ostatnia runda rozgrywana jest do końca.
}